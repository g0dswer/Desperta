...
- Sem conta, assinatura, publicidade ou analytics próprios.
- Alarmes, códigos cadastrados, preferências e fotos de referência ficam no armazenamento privado do aplicativo. Backup Android está desativado.
- Câmera: leitura de QR/código, foto e reconhecimento visual de objetos/poses. Os modelos de imagem e pose processam localmente; nenhuma API própria recebe fotografias.
...
O Android permite forçar parada, revogar permissões e desligar fisicamente o aparelho. O Desperta não promete impedir essas ações. Alarmes não tocam com o aparelho desligado; após reiniciar e desbloquear, são reagendados. Ajustes de economia de bateria de fabricantes podem exigir configuração adicional.
